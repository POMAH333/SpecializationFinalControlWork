...
public class Controller {
    ...
    private void showMainMenu() {
        String menu = "Main menu: 1. Show animals, 2. Show stats, 3. Add animal, 4. Edit animal, 0. Quit";
    ...
    private void createDog() {
        pendingAnimal = new Dogs();
        fillDataAndAdd();
    }

    private void createCat() {
        pendingAnimal = new Cats();
        fillDataAndAdd();
    }

    private void createHamster() {
        pendingAnimal = new Hamsters();
        fillDataAndAdd();
    }

    private void createHorse() {
        pendingAnimal = new Horses();
        fillDataAndAdd();
    }

    private void createCamel() {
        pendingAnimal = new Camels();
        fillDataAndAdd();
    }

    private void createDonkey() {
        pendingAnimal = new Donkeys();
        fillDataAndAdd();
    }
